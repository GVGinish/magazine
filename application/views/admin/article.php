                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="mb-3">
                              ...
                              <textarea type="text" class="form-control" name="description" placeholder="Enter article description" required></textarea>
                           </div>
                           <div class="mb-3">
                           ...
                           <div class="table-responsive">
                              <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                 ...
                                 <tbody class="gridjs-tbody">
                                    <?php $all_data=$this->db->order_by('id','DESC')->get('article')->result_array();
                                    $c=1;
                                    ...
                                    <tr class="gridjs-tr">
                                       ...
                                       <td data-column-id="price" class="gridjs-td"><span>
                                          <img src="<?=BASEURL?>assets/article/<?=$all['image']?>" width="30px" height="30px">
                                       </span></td>
                                       <td data-column-id="price" class="gridjs-td"><span><?=$all['description']?></span></td>
                                       <td data-column-id="action" class="gridjs-td">
                                          <span>
                                             <div class="dropdown">
                                                ...
                                                <li><a class="dropdown-item" href="<?= BASEURL . 'view_data/' . bin2hex($all['id']).'/article/edit_article' ?>"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                                   <li class="dropdown-divider"></li>
                                                   <li>
                                                      <a class="dropdown-item remove-list" href="<?= BASEURL . 'delete_data/' . bin2hex($all['id']) . '/magazine/add_article' ?>" data-id="1" data-bs-toggle="modal" data-bs-target="#removeItemModal">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                setTimeout(function() {
                    ...
                    window.location = '<?=BASEURL?>add_article';
                }, 2000);
            },
            error: function() {
