                              ...
                              <table class="table align-middle table-nowrap" id="customerTable">
                                 <thead class="table-light">
                                    <tr>
                                       ...
                                       <th class="sort text-center" data-sort="customer_name">Image</th>
                                       <th class="sort text-center" data-sort="action">Action</th>
                                    </tr>
                                 </thead>
                                 <tbody class="list form-check-all">
                                    <?php $all_data=$this->db->order_by('id','DESC')->get('gallery')->result_array();
                                       $c=1;
                                    ...
                                    <tr>
                                       ...
                                       <td class="customer_name text-center">                                          
                                          <img src="<?=BASEURL?>assets/gallery/<?=$all['image']?>" width="30px" height="30px">
                                       </td>
                                       <td class="text-center">
                                       <div class="d-flex gap-2 justify-content-center">
                                             <div class="edit">
                                                <a href="<?= BASEURL . 'view_data/' . bin2hex($all['id']).'/gallery/view_data' ?>" class="btn btn-sm btn-success edit-item-btn" >Edit</a>
                                             </div>
                                             <div class="remove">
                                                <button class="btn btn-sm btn-danger remove-list" href="<?= BASEURL . 'delete_data/' . bin2hex($all['id']) . '/gallery/gallery' ?>" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Remove</button>
                                             </div>
                                          </div>
                                       </td>
                                    </tr>
